<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userlogin.aspx.cs" Inherits="School_managment_system.userlogin" %>
...
<%--      <button type="submit" class="login-btn">Login</button>--%>
      ...
      <div class="register-link">
        <p>Don't have an account? <a href="userragister.aspx">Register</a></p>
      </div>
    </form>
  </div>
</body>
